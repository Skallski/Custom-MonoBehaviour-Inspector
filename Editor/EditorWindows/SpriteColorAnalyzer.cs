...
namespace BetterEditorTools.Editor.EditorWindows
{
    public class SpriteColorAnalyzer : EditorWindow
    {
        ...
        [MenuItem("SkalluUtils/Tools/Sprite Color Analyzer")]
        public static void ShowWindow()
        {
            SpriteColorAnalyzer window = GetWindow<SpriteColorAnalyzer>();
            window.titleContent = new GUIContent("Sprite Color Analyzer");
            window.Show();
        }
