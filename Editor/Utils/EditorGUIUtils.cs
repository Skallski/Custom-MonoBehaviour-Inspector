...
namespace BetterEditorTools.Editor.Utils
{
    public static class EditorGUIUtils
    {
        ...
        public static void HorizontalLine(float height = 1f, float marginTop = 2f, float marginBottom = 2f)
        {
            HorizontalLine(new Color(0f, 0f, 0f, 0.3f), height, marginTop, marginBottom);
        }
        #endregion
